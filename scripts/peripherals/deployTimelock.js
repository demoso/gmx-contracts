...
async function getArbValues() {
  ...
  return {vault, tokenManager, klpManager, rewardRouter, positionRouter, positionManager, gmx}
}
...
async function main() {
  ...
  const {vault, tokenManager, klpManager, rewardRouter, positionRouter, positionManager, gmx} = await getValues()
