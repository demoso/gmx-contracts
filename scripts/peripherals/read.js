...
async function readKlpManager(klpManager) {
  console.log("klpManager.cooldownDuration", (await klpManager.cooldownDuration()).toString())
}
...
async function main() {
  ...
  // await readKlpManager(klpManager)
  ...
  startTime = Date.now()
  await klpManager.getAums()
  console.log("klpManager.getAums", Date.now() - startTime)
}
