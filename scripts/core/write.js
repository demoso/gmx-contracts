...
async function main() {
  ...
  // const klpManager = await contractAt("KlpManager", "0x14fB4767dc9E10F96faaF37Ad24DE3E498cC344B")
  // await sendTxn(klpManager.setCooldownDuration(10 * 60), "klpManager.setCooldownDuration")
